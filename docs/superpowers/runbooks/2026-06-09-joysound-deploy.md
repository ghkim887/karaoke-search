...
- **Docs/tracking:** `docs/superpowers/specs/2026-06-09-joysound-full-catalog-sweep-design.md` (already tracked), this runbook, and `tasks/todo.md` (since consolidated into `docs/ROADMAP.md`).
