...
/**
 * Map a `RawSongRecord` from the TJ Media parser to a validated `SongRecord`.
 *
 ...
 *  - Korean fields (`title_ko`, `artist_ko`) and `release_year` stay `null`
 *    (TJ does not expose them on listing rows).
